...
const TodoItem = (props) => {
    ...
    const renameBtn = () => {
        return(
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 content-center stroke-gray-500" data-cy="todo-item-edit-button">
